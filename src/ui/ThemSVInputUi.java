...
import controller.ThemSVController;

public class ThemSVInputUi {
	private ThemSVController themSVController = null;
	private Scanner keyBoard = null;
	private PrintWriter screenPrompt = null;
	private String tenSVPrompt,loaiNganh,diaChiPrompt,ngaySinhPrompt,
	diemJavaPrompt,diemCSSPrompt,diemHTMLPrompt,diemMarketingPrompt,diemSalesPrompt;
	
	public ThemSVInputUi() {
		themSVController = new ThemSVController();
	...
	public void nhapThongTinSV() {
		...
		if ("KTPM".equalsIgnoreCase(nganh)) {
			...
			themSVController.themSV(tenSV, nganh, diaChi, ngaySinh, diemJava, diemCSS, diemHTML);
			...
			themSVController.themSV(tenSV, nganh, diaChi, ngaySinh, diemMarketing, diemSales);
		}
	}

	
	public void setThemSVController(ThemSVController themSVController) {
        this.themSVController = themSVController;
    }
}
